...
This directory contains scripts and notebooks related to the *in vitro* model analyses conducted as part of the study *Activation of transposable elements is linked to a region- and cell-type-specific interferon response in Parkinson’s disease* (Garza et al., 2025).
...
* Quality control 
* Normalization 
* Gene differential expression analysis between treatment and control conditions
* TE differential expression analysis between treatment and control conditions
