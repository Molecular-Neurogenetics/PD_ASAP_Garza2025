...
This directory contains all **analysis scripts and notebooks** supporting the study:
...
* **processing/** — 📈 Core analyses (e.g., clustering, differential expression, TE activation, visualization)
