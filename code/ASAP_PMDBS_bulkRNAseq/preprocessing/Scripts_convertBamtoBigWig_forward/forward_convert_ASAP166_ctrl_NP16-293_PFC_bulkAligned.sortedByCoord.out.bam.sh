...
bamCoverage --normalizeUsingRPKM --filterRNAstrand forward -b ASAP166_ctrl_NP16-293_PFC_bulkAligned.sortedByCoord.out.bam -o ASAP166_ctrl_NP16-293_PFC_bulk_forward.bw
