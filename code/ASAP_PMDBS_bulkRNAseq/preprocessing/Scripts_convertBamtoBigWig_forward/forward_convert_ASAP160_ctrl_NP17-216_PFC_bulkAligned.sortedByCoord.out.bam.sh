...
bamCoverage --normalizeUsingRPKM --filterRNAstrand forward -b ASAP160_ctrl_NP17-216_PFC_bulkAligned.sortedByCoord.out.bam -o ASAP160_ctrl_NP17-216_PFC_bulk_forward.bw
