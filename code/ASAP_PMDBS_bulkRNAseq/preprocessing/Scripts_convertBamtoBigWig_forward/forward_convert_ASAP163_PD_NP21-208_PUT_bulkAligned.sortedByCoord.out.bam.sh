...
bamCoverage --normalizeUsingRPKM --filterRNAstrand forward -b ASAP163_PD_NP21-208_PUT_bulkAligned.sortedByCoord.out.bam -o ASAP163_PD_NP21-208_PUT_bulk_forward.bw
