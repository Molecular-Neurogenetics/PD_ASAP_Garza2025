...
bamCoverage --normalizeUsingRPKM --filterRNAstrand forward -b ASAP220_PD_NP19-137_PUT_bulkAligned.sortedByCoord.out.bam -o ASAP220_PD_NP19-137_PUT_bulk_forward.bw
