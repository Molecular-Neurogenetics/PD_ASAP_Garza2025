...
bamCoverage --normalizeUsingRPKM --filterRNAstrand forward -b ASAP223_ctrl_NP22-37_PFC_bulkAligned.sortedByCoord.out.bam -o ASAP223_ctrl_NP22-37_PFC_bulk_forward.bw
