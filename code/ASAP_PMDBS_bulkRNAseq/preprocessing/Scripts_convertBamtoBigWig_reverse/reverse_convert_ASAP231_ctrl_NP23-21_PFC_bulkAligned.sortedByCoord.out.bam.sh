...
bamCoverage --normalizeUsingRPKM --filterRNAstrand reverse -b ASAP231_ctrl_NP23-21_PFC_bulkAligned.sortedByCoord.out.bam -o ASAP231_ctrl_NP23-21_PFC_reverse.bw
