...
bamCoverage --normalizeUsingRPKM --filterRNAstrand reverse -b ASAP214_PD_NP16-285_PUT_bulkAligned.sortedByCoord.out.bam -o ASAP214_PD_NP16-285_PUT_reverse.bw
