...
bamCoverage --normalizeUsingRPKM --filterRNAstrand reverse -b ASAP159_ctrl_16-119_PFC_bulkAligned.sortedByCoord.out.bam -o ASAP159_ctrl_16-119_PFC_reverse.bw
