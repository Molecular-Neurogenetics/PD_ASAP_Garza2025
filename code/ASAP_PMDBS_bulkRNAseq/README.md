...
This directory contains **scripts and notebooks** for the **bulk RNA-seq analyses** performed as part of the study:
...
These analyses were conducted on the **Parkinson’s Disease Molecular Atlas (PMDBS) bulk RNA-seq dataset**, focusing on transcriptome-wide detection of **transposable elements (TEs)** across brain regions using deep bulk RNAseq.
...
* Identification of expressed TEs in these samples  
...
No unified workflow or container is provided; scripts are run individually in a standard R or Python environment with the required packages installed.
