...
This directory contains all scripts, notebooks, and workflows used for the single-nucleus RNA sequencing (snRNA-seq) component of the study *Activation of transposable elements is linked to a region- and cell-type-specific interferon response in Parkinson’s disease* (Garza et al., 2025). Raw data used for this analyses has been deposited in (Zenodo DOI:10.5281/zenodo.15162835)[https://zenodo.org/records/15162835].

Analyses here were performed on the Parkinson’s Disease Molecular Atlas (PMDBS) dataset, focusing on the transcriptional and transposable element (TE) landscape across different brain regions and cell types.
...
* Differential expression and transposable element (TE) activation analyses
...
3. Input/output paths need to be fixed to your environment.

Ensure that your R/Python installations include the packages required for each script (listed in code headers or comments).
