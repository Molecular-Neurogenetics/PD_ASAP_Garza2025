...
5. Process cluster-level outputs, generating gene and TE counts per cluster.
...
# Experiment setup
# --------------------------------------------------------------------
region = "PFC"  # Prefrontal Cortex region
...
# Quantify gene and TE expression
...
# TE_counts=True to include transposable element quantification
