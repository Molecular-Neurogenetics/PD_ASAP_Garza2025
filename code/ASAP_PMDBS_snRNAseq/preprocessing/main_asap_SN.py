...
5. Process cluster-level outputs (trusTEr pipeline), generating gene counts per cluster.
...
# Paths for parent directory and configuration files
...
# Experiment setup
# --------------------------------------------------------------------
region = "SN"  # This script is specific to the Substantia Nigra region
